package com.shahriar.androidtestapplication.Listeners;
...
public class VerseTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public VerseTouchListener(Context context, final RecyclerView recyclerView, final OnRecycleViewClicked clickListener) {
