...
public class SurahAtTariq extends Surah {
    ...
    protected final int duration[] ={0, 7050,12200,17754,21654,28900,36600,43000,50900,56400,61200,68000,73000,76400,81400,84000,89000,92050,99100,Integer.MAX_VALUE};
