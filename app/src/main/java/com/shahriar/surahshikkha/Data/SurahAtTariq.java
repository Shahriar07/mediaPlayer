...
public class SurahAtTariq extends Surah {
    ...
    protected final int duration[] ={0, 7050,12340,18100,21954,29300,36600,43000,50900,56400,61400,68200,73150,76400,81700,84400,89400,92300,99100,Integer.MAX_VALUE};
